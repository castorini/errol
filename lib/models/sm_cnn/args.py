...
def get_args():
    ...
    parser.add_argument('--dataset', type=str, default='Reuters', choices=['microblog'])
    ...
    parser.add_argument('--save-path', type=str, default=os.path.join(os.pardir, 'model_checkpoints', 'kim_cnn'))
